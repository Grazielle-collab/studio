...
export default function PoliticaPrivacidade() {
  return (
    <div className="min-h-screen bg-[#e9e2db]">
      <div className="max-w-4xl mx-auto px-6 py-20">
        
        {/* Botão de voltar */}
        <Link 
          href="/"
          className="inline-flex items-center gap-2 text-sm uppercase tracking-[4px] hover:opacity-60 transition mb-12"
        >
          ← Voltar
        </Link>
        ...
        <div className="space-y-8">
          ...
          {/* Seção 2 */}
          <section>
            <h3 className="text-xl font-medium mb-4">2. Alterações na Política de Privacidade</h3>
            <p>
          ...
          {/* Seção 3 */}
          <section>
            <h3 className="text-xl font-medium mb-4">3. Informações Coletadas e Finalidade do Tratamento dos Dados Pessoais</h3>
            <p className="mb-4">
          ...
          <section>
            <h3 className="text-xl font-medium mb-4">4. Seus Direitos</h3>
            <p className="mb-4">
            ...
            <p className="mt-4">
              ...
              <a href="mailto:contato@cardealstudio.com" className="underline hover:opacity-60">
          ...
          <section>
            <h3 className="text-xl font-medium mb-4">5. Compartilhamento de Dados</h3>
            <p>
          ...
          {/* Seção 6 - Segurança */}
          <section>
            <h3 className="text-xl font-medium mb-4">6. Segurança e Armazenamento</h3>
            <p>
          ...
          {/* Seção 7 - Cookies */}
          <section>
            <h3 className="text-xl font-medium mb-4">7. Cookies e Tecnologias Semelhantes</h3>
            <p>
          ...
          <section className="bg-white/50 p-6 rounded-lg">
            <h3 className="text-xl font-medium mb-4">8. Contato</h3>
            <p className="mb-2">
            ...
            <p className="mt-4">
              ...
              <a href="https://wa.me/5511997907029" className="underline hover:opacity-60">
                (11) 99790-7029
              </a>
            </p>
          </section>
          ...
          {/* Seção 9 - Foro */}
          <section>
            <h3 className="text-xl font-medium mb-4">9. Legislação e Foro</h3>
            <p>
